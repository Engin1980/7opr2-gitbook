...
<table><thead><tr><th width="206">Hodnota</th><th width="380">Význam</th></tr></thead><tbody><tr><td><code>WRITE</code></td><td>Otevře soubor pro zápis.</td></tr><tr><td><code>APPEND</code></td><td>Při zápisu se bude přidávat na konec souboru. Používá se v kombinaci s <code>WRITE</code> nebo <code>CREATE</code>.</td></tr><tr><td><code>TRUNCATE_EXISTING</code></td><td>Smaže obsah otevíranému souboru (soubor se tedy otevře, smaže se jeho obsah a případný zápis se provádí od začátku souboru). Používá se v kombinaci s <code>WRITE</code>.</td></tr><tr><td><code>CREATE_NEW</code></td><td>Otevře nový soubor. Pokud již soubor existuje, vyhodí se výjimka.</td></tr><tr><td><code>CREATE</code></td><td>Otevře soubor. Pokud soubor neexistuje, vytvoří se nový.</td></tr><tr><td><code>DELETE_ON_CLOSE</code></td><td>Smaže soubor po ukončení práce. Používá se pro dočasné soubory, které poté programátor nemusí mazat ručně.</td></tr></tbody></table>
...
<table><thead><tr><th width="169">Směr</th><th width="175">Typ dat</th><th width="208">Název</th></tr></thead><tbody><tr><td>Vstupní</td><td>Byty</td><td><code>InputStream</code></td></tr><tr><td>Výstupní</td><td>Byty</td><td><code>OutputStream</code></td></tr><tr><td>Vstupní</td><td>Znaky</td><td><code>Reader</code></td></tr><tr><td>Výstupní</td><td>Znaky</td><td><code>Writer</code></td></tr></tbody></table>
...
<table><thead><tr><th width="230">Název třídy</th><th width="378">Použití</th></tr></thead><tbody><tr><td><p><code>ByteArrayInputStream</code></p><p><code>ByteArrayOutputStream</code></p></td><td>Proudy pro čtení/zápis do pole bytů. Programátor tak nemusí k poli bytů přistupovat pomocí indexů, ale vytvoří si polem proud a jednotlivé byty čte nebo zapisuje postupně.</td></tr><tr><td><p><code>PushbackInputStream</code></p><p><code>PushbackReader</code></p></td><td>Přidává funkcionalitu čtení dalšího znaku bez jeho výběru. Nad vnořeným streamem tedy umí provést operaci, kdy se „podívá", co je další znak.</td></tr><tr><td><code>SequenceInputStream</code></td><td>Umožňuje zařadit čtení několika proudů za sebou. Jakmile jsou vyčtena všechna data z proudu prvního, pokračuje čtení proudem dalším. Vstupní proudy se zadávají v konstruktoru této třídy.</td></tr><tr><td><p><code>PrintStream</code></p><p><code>PrintWriter</code></p></td><td>Alternativa k proudu <code>OutputStream</code>. Příkladem může být <code>System.out</code>. Umí lépe (smysluplněji) vypisovat metodou <code>write()</code> jiné datové typy; hlavně však u těchto operaci nevyhazuje výjimky, takže se výpisy nemusí balit do sekvence try-catch.</td></tr><tr><td><p><code>CharArrayReader</code></p><p><code>CharArrayWriter</code></p></td><td>Obdoba typu <code>ByteArrayInputStream</code>, podkladovými daty je však pole znaků (nikoliv bytů).</td></tr></tbody></table>
